...
import gaqBg from "../../public/Images/get-a-questions-back.jpg";
...
const Contact = () => {
  ...
  const gaqBgStyle = {
   ...
   // Call useStateContext inside the component
        ...
        <div className="row">
          <div className="map-col">
            <div className="contact-box-wrap">
              ...
              <div className="contact-box">
                <div className="line-title">
                  <h4 className="h4-title"> office</h4>
                </div>
                <ul>
                  <li>
                    <a href="/">
